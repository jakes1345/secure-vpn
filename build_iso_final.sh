...
# ============================================
# TIER 3: GAMING (PERFORMANCE OPTIMIZED)
# ============================================
...
# Game Launchers (Using Flatpak for others)
# heroic-games-launcher (Install via Flatpak)
# bottles (Install via Flatpak)
flatpak
...
mangohud
lib32-mangohud
# vkbasalt removed to ensure stability
...
xf86-video-vesa
mesa-demos
# Explicitly use standard Vulkan
vulkan-radeon
lib32-vulkan-radeon
vulkan-intel
lib32-vulkan-intel
...
sof-firmware
wireless-regdb
# Additional firmware packages for better hardware support
linux-firmware-marvell
# Note: linux-firmware is already included in TIER 1 (line 26)
...
# PhazeBrowser Native Dependencies
qt6-base
qt6-webengine
qt6-declarative
qt6-svg
