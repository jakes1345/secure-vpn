...
class PhazeVPNProductionServer:
    ...
    async def start(self):
        ...
        # Start UDP server with SO_REUSEADDR to avoid port conflicts
...
async def main():
    ...
    # Use port 51820 (PhazeVPN Protocol default) or 443 for stealth
    # Can be overridden with PHAZEVPN_PORT environment variable
    default_port = int(os.environ.get('PHAZEVPN_PORT', 51820))
    server = PhazeVPNProductionServer(host='0.0.0.0', port=default_port)
