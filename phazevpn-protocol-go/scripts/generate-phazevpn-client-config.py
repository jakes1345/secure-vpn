...
def generate_phazevpn_config(client_name, server_host, server_port, username=None, password=None, output_dir=None):
    """
    Generate PhazeVPN Protocol client configuration
    ...
    Args:
        ...
        server_port: Server port (default: 51821)
    ...
    client_public_key = base64.b64encode(secrets.token_bytes(32)).decode()
...
if __name__ == "__main__":
    ...
    server_host = sys.argv[2] if len(sys.argv) > 2 else "phazevpn.com"
