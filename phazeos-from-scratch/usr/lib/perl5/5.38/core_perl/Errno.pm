...
"x86_64-linux-6.14.0-37-generic" or
	die "Errno architecture (x86_64-linux-6.14.0-37-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
